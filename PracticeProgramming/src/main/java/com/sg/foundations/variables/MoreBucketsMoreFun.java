...
public class MoreBucketsMoreFun {
    public static void main(String[] args) {
        ...
        // Using the decrement operator -- that subtracts 1 from 5
        butterflies--;
        System.out.println("Now there are only " + butterflies + " butterflies left.");

        // the number of bugs remain the same because we have not changed
        // its initial value but rather modified the number of
        // butterflies in a certain intance
